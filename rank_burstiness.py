    ...
    for sequence in sequences:
        ...
        for i,interval in enumerate(s[1:]):
            ...
            for state in [0,1]:
                ...
                print "pro[0][state]",pro[0][state]
                print "observed",observed
                print "(optimal_state[0][0]*pro[0][state]*observed)",(optimal_state[0][0]*pro[0][state]*observed)
                print "optimal_state[1][0]",optimal_state[0][0]
                print "pro[1][state]",pro[0][state]
                print "observed",observed
                print "(optimal_state[1][0]*pro[1][state]*observed)",(optimal_state[0][0]*pro[0][state]*observed)
                opts = [(optimal_state[statem1][0]*pro[statem1][state]*observed) for statem1 in [0,1]]
                quit()
